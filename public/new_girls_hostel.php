...
<html>
  <head>
    ...
    <title>New Girls Hostel :: GCOEA Hostel</title>
  </head>
  <body>
      ...
      <div id="content-wrapper" class="container">
        <div class="row">
          <div id="content" class="col s8">
            <h4>New Girls Hostel</h4><?php print_message(); ?>
            <p>Year of Establishment: 2014<br>Intake capacity: 160<br>Strength: 160</p>
          </div>
