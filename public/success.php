...
<html>
  <head>
    ...
    <title>Success :: GCOEA Hostel</title>
  </head>
  <body>
      ...
      <div id="content-wrapper" class="container">
        <div class="row">
          <div id="content" class="col s8">
            <h4>Success</h4><?php print_message(); ?>
            <p>You form has been submitted successfully. Please note the below token id for future reference.</p>
            <div class="card">
              <div class="card-content">
                <center>
                  <h3><?php if(is_numeric($_GET['token'])) echo $_GET['token']; else echo "Invalid token"; ?></h3>
                </center>
              </div>
            </div>
          </div>
