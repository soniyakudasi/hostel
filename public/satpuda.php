...
<html>
  <head>
    ...
    <title>Satpuda Boys Hostel :: GCOEA Hostel</title>
  </head>
  <body>
      ...
      <div id="content-wrapper" class="container">
        <div class="row">
          <div id="content" class="col s8">
            <h4>Satpuda Boys Hostel</h4><?php print_message(); ?>
            <p>Year of Establishment: 1980<br>Intake capacity: 180<br>Strength: 204</p>
          </div>
