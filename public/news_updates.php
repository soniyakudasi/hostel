...
<html>
  <head>
    ...
    <title>News and updates :: GCOEA Hostel</title>
  </head>
  <body>
      ...
      <div id="content-wrapper" class="container">
        <div class="row">
          <div id="content" class="col s8">
            <h4>News and updates</h4><?php print_message(); ?>
            <p>
               
              Hostel Admission Process for 2015-16<br>Document Verification and Validation 2015-16
            </p>
          </div>
